...
fun main() {
    ...
    val result = (favorableWeatherToday == FAVORABLE_WEATHER_CONDITIONS) && (provisions > minProvision) &&
            ((shipDamage != NO_DAMAGE) && (crewSize in minCrew until recommendedCrew) || (crewSize == recommendedCrew))
